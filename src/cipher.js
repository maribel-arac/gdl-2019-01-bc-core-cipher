window.cipher = {
 ...
 encode: (offset, message)=> {
	let text = " "; // va vacio porque es lo que va a regresar el FOR (funcion gral)
	...
	let newLetter = String.fromCharCode(location); /* se pone String poara hablar de dady String y location es 
	el resultado de donde se guardaron */
 ...
 decode: (offset, message)=> {
	...
	/* se pone String poara hablar de dady String y location es 
	el resultado de donde se guardaron */
	/*console.log(newLetter); // esta jala la ubicación de las letras */
